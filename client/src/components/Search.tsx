        ...
        <>
            {
                ...
                <div id="box" onClick={clickBox} className="fixed bg-slate-950 backdrop-blur-sm bg-opacity-10 top-0 bottom-0 left-0 right-0 z-10">
                    <form className="p-4 rounded shadow bg-white absolute left-1/2 top-1/3 -translate-x-1/2 -translate-y-1/2 max-sm:w-10/12">
                        ...
                        <div className="border p-2 mt-4 flex gap-4 rounded">
                            ...
                            <input autoFocus onKeyDown={handleKeyDown} className="outline-none w-full" type="text" placeholder="Search..." />
                            <span>ESC</span>
                        </div>
                    </form>
                </div>
